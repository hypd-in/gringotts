<template>
  <section class="brand-creator-wrapper">
    <div
      @click="goToBrandPage"
      v-if="brandInfo"
      class="brand-info-container info-container-wrapper"
    >
      ...
      <button class="visit-brand">
        ...
        >
          <path
            d="M8.66663 7.33337L14.1333 1.8667"
            stroke="#2597DF"
            stroke-width="1.5"
          ...
          />
          <path
            d="M14.6667 4.53325V1.33325H11.4667"
            stroke="#2597DF"
            stroke-width="1.5"
            stroke-linecap="round"
            stroke-linejoin="round"
    ...
    <div
      ...
      v-if="creatorInfo"
      class="info-container-wrapper creator-info-wrapper"
    >
