  ...
  <div class="header">
    <section class="desktop-header">
      ...
      <div class="header-action-btns">
        ...
        >
          <span v-if="!store.state.user?.id">Sign in</span>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div class="back-btn">
        <button @click="goBack" class="back">
          ...
          >
            ...
            />
            <path
              d="M2 12C5.25 11 7.25 9 8 6"
              stroke="#13141B"
              stroke-width="1.5"
              stroke-linecap="round"
            />
            <path
              d="M2 12C5.25 13 7.25 15 8 18"
              stroke="#13141B"
              stroke-width="1.5"
              stroke-linecap="round"
            />
...
function goToExplore() {
  if (route.params.creator_username) {
    router.push({
      name: "hypdExplore",
      params: route.params.creator_username,
      query: {
